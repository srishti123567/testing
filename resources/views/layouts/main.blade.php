...
<body>
    ...
    <div id="main-wrapper">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/userlist')}}" aria-expanded="false"><i class="fa fa-user m-b-5 font-16"></i><span class="hide-menu">Users List</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/productlist')}}" aria-expanded="false"><i class="fa fa-table m-b-5 font-16"></i><span class="hide-menu">Product List</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{url('/enquiry')}}" aria-expanded="false"><i class="fas fa-comment-alt m-b-5 font-16"></i><span class="hide-menu">Enquiry</span></a></li>
                    </ul>
                </nav>
        ...
        <div class="page-wrapper">
            ...
            <footer class="footer text-center">
                All Rights Reserved by GodParticle Designed and Developed by </a>.
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
    ...
    <script src=" {{url('assets/dist/js/jquery.ui.touch-punch-improved.js')}}"></script>
    ...
    <script src="{{url('assets/dist/js/pages/calendar/cal-init.js')}}"></script>
    <!-- this page js --> 
...
<script>
    window.baseurl = "http://localhost/samejeans/";
...
var openFile = function(event) {
	...
	reader.onload = function(){
		...
		document.getElementById("TheImageContents").innerHTML = '<img width="100" height="100" src="'+TheFileContents+'" /></p>';
	};
